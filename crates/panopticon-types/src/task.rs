...
use crate::error::PanopticonError;
...
impl TaskState {
    ...
    pub fn transition(self, event: TaskEvent) -> crate::error::Result<TaskState> {
        match (self, event) {
            // From Pending
...
impl Task {
    ...
    pub fn apply_event(&mut self, event: TaskEvent) -> crate::error::Result<()> {
