use panopticon_types::{Agent, PanopticonError, Result, Task, TrustLevel};

use crate::level::{ApprovalLevel, ApprovalRequirement};
...
impl PermissionEvaluator {
    ...
    fn adjust_for_trust(
        ...
        characteristics: &panopticon_types::TaskCharacteristics,
    ) -> ApprovalRequirement {
...
mod tests {
    use super::*;
    use panopticon_types::{Agent, Capability, PermissionSet, TaskCharacteristics};
